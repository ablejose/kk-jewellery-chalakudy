...
export const BRAND: BrandConfig = {
  ...
  description:
    "KK jewellery is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy with timeless craftsmanship and elegant designs for every celebration.",
  ...
  storeImages: [
    "https://lh3.googleusercontent.com/gps-cs-s/AHRPTWnQo1gPcQ699cvNPpyk7nxLFj6E7SpZ3ar4WxUroW70fi9npz5UshwxcCrQ9pcC-G4irID7yowtY3Kr5BDjedkhgwk-ihyZYzL39fUym6uiAhFNgHq2AOIwZo9lMdgrLB0dwIU=s1600",
  ...
  seo: {
    title: "KK jewellery | Jewellery in Chalakudy",
    description:
      "KK jewellery is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy with timeless craftsmanship and elegant designs for every celebration.",
    keywords: [
      "KK jewellery",
